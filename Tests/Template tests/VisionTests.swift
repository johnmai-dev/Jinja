...
final class VisionTests: XCTestCase {
    ...
    func testLlama3_2_11BVisionInstructTextChatOnly() throws {
        ...
        if target != result {
            print("::: testLlama3_2_11BVisionInstructTextChatOnly failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    func testLlama3_2_11BVisionInstructWithImages() throws {
        ...
        if target != result {
            print("::: testLlama3_2_11BVisionInstructWithImages failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    func testQwen2VLWithImages() throws {
        ...
        if target != result {
            print("::: testQwen2VLWithImages failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    func testQwen2VLWithVideo() throws {
        ...
        if target != result {
            print("::: testQwen2VLWithVideo failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    func testLlama3_2_11BVisionInstructWithTools() throws {
        ...
        if target != result {
            print("::: testLlama3_2_11BVisionInstructWithTools failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
