...
final class ToolUseTests: XCTestCase {
    ...
    func testMeetKaiFunctionaryMediumV2_2() throws {
        ...
        if target != result {
            print("::: testMeetKaiFunctionaryMediumV2_2 failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    func testFireworksAIFireFunctionV1() throws {
        ...
        if target != result {
            print("::: testFireworksAIFireFunctionV1 failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    //
    //            if target != result {
    //                print("::: testMistral7BInstructV0_3JSONSchema failed.")
    //                print("::: target:")
    //                print(target)
    //                print("::: result:")
    //                print(result)
    ...
    //
    //        if target != result {
    //            print("::: testCISCaiMistral7BInstructV0_3SOTAGGUF failed.")
    //            print("::: target:")
    //            print(target)
    //            print("::: result:")
    //            print(result)
    ...
    func testNousResearchHermes2ProLlama38BJSONSchema() throws {
        ...
        if target != result {
            print("::: testNousResearchHermes2ProLlama38BJSONSchema failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
    ...
    //
    //        if target != result {
    //            print("::: testMetaLlamaLlama3_18BInstruct failed.")
    //            print("::: target:")
    //            print(target)
    //            print("::: result:")
    //            print(result)
    ...
    func testLlama3_1() throws {
        ...
        if target != result {
            print("::: testLlamaLlama3_1 failed.")
            print("::: target:")
            print(target)
            print("::: result:")
            print(result)
